...
$mail->Port = "465";
//Set gmail username
$mail->Username = "abdulmuminibrahim668@gmail.com";
//Set gmail password
$mail->Password = "smvpiijjryibkwsz";
//Email subject
$mail->Subject = $subject;
//Set sender email
$mail->setFrom('abdulmuminibrahim668@gmail.com', "User Complain");
//Enable HTML
$mail->isHTML(true);
//Attachment
...
$mail->Body = $message;
//Add recipient
$mail->addAddress('abdulmuminibrahim668@gmail.com'); // admin recieves the mail
//Finally send email
if ( $mail->send() ) {
...
$mail->addCC($email); //send copy to the user
...
<footer>
  <p>Copyright &copy; <?php echo date("Y"); ?>Department of Software Engineering, Al-Qalam University, Katsina.</p>
</footer>
    <!--end  -->
</body>
</html>